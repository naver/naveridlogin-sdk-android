...
import com.nhn.android.oauth.test.task.OAuthLoginAsyncTask;
...
public class OAuthSampleActivity extends Activity {
    ...
    private static final String TAG = OAuthSampleActivity.class.getSimpleName();
    ...
    private void initData() {
		 ...
		 */
        //mOAuthLogin.init(mContext, OAUTH_CLIENT_ID, OAUTH_CLIENT_SECRET, OAUTH_CLIENT_NAME, OAUTH_callback_intent_url);
    }
    ...
    public void onButtonClick(View v) throws Throwable {
        ...
        switch (v.getId()) {
            ...
            case R.id.buttonVerifier: {
                new OAuthLoginAsyncTask<Void, String>()
                        .preCallback(()-> mApiResultText.setText(""))
                        .job(params -> {
                            String url = "https://openapi.naver.com/v1/nid/me";
                            String at = mOAuthLoginInstance.getAccessToken(mContext);
                            return mOAuthLoginInstance.requestApi(mContext, at, url);
                        })
                        .postCallback(result-> mApiResultText.setText(result))
                        .execute();
                break;
            }
            case R.id.buttonRefresh: {
                new OAuthLoginAsyncTask<Void, String>()
                        .job(params -> mOAuthLoginInstance.refreshAccessToken(mContext))
                        .postCallback(result -> updateView())
                        .execute();
                break;
            }
            ...
            case R.id.buttonOAuthDeleteToken: {
                new OAuthLoginAsyncTask<Void, Void>()
                        .job(params -> {
