package com.navercorp.nid.core.data.errorcode
...
enum class NidOAuthErrorCode(
    ...
    NEED_APP_UPDATE("need_app_update", "need_app_update"),
    SDK_EXECUTION_ERROR("sdk_execution_error", "sdk_execution_error");
